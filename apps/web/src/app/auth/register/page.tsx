...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(
        err.message || "An error occurred during account generation.",
      );
      setStep(1);
    } finally {
      setLoading(false);
          ...
          {step === 1 && (
            <div className="space-y-4">
              <div className="form-control">
                <label className="label text-caption font-mono uppercase text-gray-400 font-bold p-0 mb-1.5">
        ...
        <div className="max-w-md text-center space-y-8 flex flex-col items-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-white/80 max-w-sm mx-auto leading-relaxed">
              Build your customized learning timeline milestones, clear
              assessments, and document verified scores to stand out.
            </p>
          </div>
