  ...
  return (
    <div className={`min-h-screen -mt-24 bg-base-100 flex flex-col md:grid md:grid-cols-12 overflow-hidden select-none relative ${isRtl ? 'rtl' : 'ltr'}`}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`btn text-xs font-extrabold rounded-full h-11 border flex items-center justify-center gap-1.5 ${role === "learner"
                      ? "bg-[#8E1616] text-white hover:bg-[#701111] border-none animate-none"
              ...
              {role === "learner" ? (
                <>
                  <div className="form-control">
                    ...
                    <select
                      className={`select select-bordered w-full bg-transparent border-base-300 text-base-content rounded-xl text-sm focus:border-[#8E1616] h-11 ${isRtl ? 'text-right' : 'text-left'}`}
                      value={targetGoal}
                ...
                <>
                  <div className="form-control">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full bg-transparent border-base-300 text-base-content rounded-xl text-sm focus:border-[#8E1616] h-11 ${isRtl ? 'text-right' : 'text-left'}`}
                      value={companyName}
      ...
      <div className="col-span-12 md:col-span-7 hidden md:flex items-center justify-center p-10 relative overflow-hidden">
        <AuthVisualBanner mode="register" className="w-full max-w-xl" />
      </div>
