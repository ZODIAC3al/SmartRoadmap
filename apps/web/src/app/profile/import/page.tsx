      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <div className="flex items-center justify-between pt-4">
          <div>
            ...
            <p className="text-xs text-base-content/70 dark:text-stone-300 font-medium mt-1">
        ...
        <section className="bg-base-200 border border-base-300 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">
                  {ghAccount
            ...
            <div className="mt-4 flex flex-col gap-3 bg-base-100 border border-base-300 rounded-xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="text-xs">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {ghAccount.username && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[#7c3aed] hover:underline text-[11px] font-medium transition-all duration-300 ease-in-out"
                      >
                        @{ghAccount.username} ↗
                      </a>
                    )}
                  </div>
                  <p className="text-base-content/70 dark:text-stone-300 font-medium">
                  ...
                  {ghAccount.lastSyncedAt && (
                    <p className="text-[10px] text-base-content/70 dark:text-stone-400 font-medium mt-0.5">
              ...
              {ghAccount.languagesSummary && Object.keys(ghAccount.languagesSummary).length > 0 && (
                <div className="flex items-center gap-1.5 flex-wrap pt-2 border-t border-base-200">
                  <span className="text-[11px] font-semibold text-base-content/70 dark:text-stone-300 font-medium mr-1">{L('Top Languages:', 'أبرز اللغات:')}</span>
          ...
          {ghAccount && repos.length === 0 && (
            <div className="mt-4 p-4 rounded-xl bg-base-100 border border-base-300 text-center text-xs text-base-content/70 dark:text-stone-300 font-medium">
            ...
            <div className="mt-4 space-y-3">
              <div className="overflow-x-auto border border-base-300 rounded-xl">
                <table className="table table-sm text-xs">
                  ...
                  <tbody>
                    {repos.map((r) => (
                      <tr key={r.id} className="hover:bg-base-100 transition-all duration-300 ease-in-out">
                        <td>
                          <input
                            type="checkbox"
                        ...
                        <td>
                          ...
                          {r.description && <p className="text-[10px] text-base-content/70 dark:text-stone-300 font-medium line-clamp-1">{r.description}</p>}
                        </td>
                        <td>{r.language || '—'}</td>
        ...
        <section className="bg-base-200 border border-base-300 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">{L('Connect or import your profile.', 'اربط أو استورد ملفك الشخصي.')}</p>
              </div>
            </div>
            {liAccount ? (
              ...
              <button onClick={connectLinkedIn} className="btn bg-[#0a66c2] hover:bg-[#004182] border-none text-white btn-sm rounded-xl font-bold transition-all duration-300 ease-in-out">
            ...
            <div className="mt-4 flex flex-col gap-3 bg-base-100 border border-base-300 rounded-xl p-4 text-xs">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-0.5">
                  ...
                  {liAccount.email && <p className="text-base-content/70 dark:text-stone-300 font-medium">{liAccount.email}</p>}
          ...
          <div className="mt-4 bg-info/10 border border-info/30 rounded-xl p-3 text-[11px] text-base-content dark:text-stone-200 font-medium">
          ...
          <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-base-100 border border-base-300 rounded-xl p-4 space-y-3">
              ...
              <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">{L('Export your LinkedIn profile as PDF and upload it. We extract the text so you can complete the fields above.', 'صدّر ملف LinkedIn كـ PDF وارفعه. نستخرج النص لإكمال الحقول أعلاه.')}</p>
              <input
                type="file"
              ...
              />
              {liForm && (
                <div className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">
          ...
          {liAccount?.profile && (
            <div className="mt-4 bg-base-100 border border-base-300 rounded-xl p-4 text-xs space-y-2 text-start">
              ...
              {liAccount.profile.headline && <p className="text-base-content/70 dark:text-stone-300 font-medium">{liAccount.profile.headline}</p>}
              {liAccount.profile.about && <p className="text-base-content/70 dark:text-stone-300 font-medium">{liAccount.profile.about}</p>}
        ...
        <section className="bg-base-200 border border-base-300 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">{L('Upload and manage your professional certifications with official verification.', 'ارفع وأدر شهاداتك المهنية مع التحقق والتوثيق الرسمي.')}</p>
            </div>
          </div>
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center space-y-2">
                  <span className={`w-8 h-8 rounded-full bg-base-100 flex items-center justify-center border border-base-300 ${certFile ? 'text-success' : 'text-base-content/70 dark:text-stone-400 font-medium'}`}>
                    {certFile ? <CheckIcon /> : <UploadIcon />}
                  </span>
                  {certFile ? (
                    <div className="text-xs">
                      <p className="font-bold truncate max-w-[200px]">{certFile.name}</p>
                      <p className="text-[10px] text-base-content/70 dark:text-stone-300 font-medium">{(certFile.size / 1024 / 1024).toFixed(2)} MB</p>
                    </div>
                  ) : (
                    <div className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">
                      <p className="font-bold">{L('Drag & drop your certificate', 'اسحب وأفلت شهادتك هنا')}</p>
                      <p className="text-[10px] text-base-content/70 dark:text-stone-400 font-medium mt-1">{L('Supports PDF, JPG, JPEG, PNG up to 5MB', 'يدعم صيغ PDF, JPG, JPEG, PNG حتى 5 ميجابايت')}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {certs.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-8 bg-base-100/50 border border-base-300 rounded-xl text-center">
                  <p className="text-xs text-base-content/70 dark:text-stone-400 font-medium">{L('No certificates uploaded yet.', 'لم يتم رفع أي شهادات بعد.')}</p>
                </div>
              ) : (
                        ...
                        <div className="card-body p-4 space-y-3 text-start">
                          <div className="flex justify-between items-start gap-2">
                            <div className="min-w-0">
                              ...
                              {c.organization && <p className="text-[10px] text-base-content/70 dark:text-stone-300 font-medium font-semibold">{c.organization}</p>}
                            </div>
                            <div className="flex gap-1 flex-shrink-0">
                              <button
                                onClick={() => setEditingCert(c)}
                                className="btn btn-ghost btn-xs text-info p-1 hover:bg-info/10 transition-all duration-300 ease-in-out"
                                title={L('Edit', 'تعديل')}
                              >
                                <EditIcon />
                              </button>
                              <button
                                ...
                                className="btn btn-ghost btn-xs text-error p-1 hover:bg-error/10 transition-all duration-300 ease-in-out"
                                title={L('Delete', 'حذف')}
                              >
                                <TrashIcon />
                              </button>
                          ...
                          {status === 'Rejected' && c.rejectionReason && (
                            <div className="p-2 rounded-2xl bg-error/10 border border-error/20 text-[10px] text-error space-y-0.5">
                          ...
                          <div className="text-[10px] text-base-content/70 dark:text-stone-300 font-medium space-y-1 bg-base-200/50 rounded-2xl p-2">
                            <p>
        ...
        <section className="bg-base-200 border border-base-300 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between gap-3 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium">{L('Manage the projects that have been imported into your profile.', 'أدر المشاريع التي تم استيرادها إلى ملفك الشخصي.')}</p>
              </div>
            </div>
          </div>
          ...
          {projects.length === 0 ? (
            <div className="flex flex-col items-center justify-center p-8 bg-base-100/50 border border-base-300 rounded-xl text-center">
              <p className="text-xs text-base-content/70 dark:text-stone-400 font-medium">{L('No portfolio projects imported yet.', 'لم يتم استيراد أي مشاريع في معرض الأعمال بعد.')}</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {projects.map((p) => (
                  ...
                  <div className="card-body p-4 space-y-2 text-start">
                    <div className="flex justify-between items-start gap-2">
                      <div className="min-w-0">
                        ...
                        {p.lastUpdated && <p className="text-[9px] text-base-content/70 dark:text-stone-400 font-medium mt-0.5">{L('Updated: ', 'تحديث: ')}{formatDate(p.lastUpdated)}</p>}
                      </div>
                      <div className="flex gap-1 flex-shrink-0">
                        <button
                    ...
                    {p.description && <p className="text-[11px] text-base-content/70 dark:text-stone-300 font-medium line-clamp-2 leading-relaxed">{p.description}</p>}

                    {p.technologies && p.technologies.length > 0 && (
                      <div className="flex flex-wrap gap-1 pt-1">
                        {p.technologies.map((t) => (
                          <span key={t} className="badge badge-sm font-semibold bg-base-200 border-none text-base-content/70 dark:text-stone-300 font-medium text-[9px] px-1.5 py-0.5 rounded">
                            {t}
                          </span>
                        ))}
                      </div>
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-base-200 border border-base-300 rounded-2xl max-w-md p-6">
            <div className="flex justify-between items-center border-b border-base-300 pb-3 mb-4">
              ...
              <button onClick={() => setEditingCert(null)} className="btn btn-ghost btn-circle btn-xs text-base-content/70 dark:text-stone-300 font-medium">
                <CloseIcon />
              </button>
            </div>
            ...
            <div className="space-y-3 text-start">
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Title *', 'العنوان *')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Issuing Organization', 'الجهة المانحة')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="form-control">
                  <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Issue Date', 'تاريخ الإصدار')}</label>
                  <input
                    type="date"
                    className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
                ...
                <div className="form-control">
                  <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Expiration Date', 'تاريخ الانتهاء')}</label>
                  <input
                    type="date"
                    className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Credential ID', 'معرّف الشهادة')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Credential URL', 'رابط الشهادة')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-base-200 border border-base-300 rounded-2xl max-w-md p-6">
            <div className="flex justify-between items-center border-b border-base-300 pb-3 mb-4">
              ...
              <button onClick={() => setEditingProject(null)} className="btn btn-ghost btn-circle btn-xs text-base-content/70 dark:text-stone-300 font-medium">
                <CloseIcon />
              </button>
            </div>
            ...
            <div className="space-y-3 text-start">
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Name *', 'الاسم *')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Description', 'الوصف')}</label>
                <textarea
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Demo Link', 'رابط الديمو')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
              ...
              <div className="form-control">
                <label className="label text-[10px] font-bold uppercase text-base-content/70 dark:text-stone-400 font-medium font-mono block mb-1">{L('Technologies (comma separated)', 'التقنيات (مفصولة بفاصلة)')}</label>
                <input
                  className="input input-bordered input-sm w-full bg-base-100 text-xs rounded-xl"
