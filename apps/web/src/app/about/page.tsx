...
export default function AboutPage() {
  return (
    <div className="bg-base-100 text-base-content min-h-screen">
      ...
      {/* Quote */}
      <section className="max-w-2xl mx-auto px-6 pb-16">
        <blockquote className="text-lg sm:text-xl font-medium text-base-content italic leading-snug">
      ...
      {/* Join Us */}
      <section className="max-w-2xl mx-auto px-6 pb-16">
        <h2 className="text-xl font-bold text-base-content mb-3">Join Us</h2>
      ...
      <section className="max-w-2xl mx-auto px-6 pb-20">
        <h2 className="text-xl font-bold text-base-content mb-2">Our Team</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {TEAM.map((person) => (
            <div key={person.name} className="text-center">
              ...
              <p className="text-[11px] text-base-content/70 mt-0.5 leading-snug">
                {person.role}
              </p>
            </div>
          ))}
