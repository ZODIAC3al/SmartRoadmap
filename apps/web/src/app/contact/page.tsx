    ...
    <div className="flex flex-col min-h-screen bg-base-100 text-base-content">
      ...
      <section className="pb-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs text-stone-600 dark:text-stone-400 font-medium font-bold mb-4 tracking-wide">
            {t("contact.subtitle")}
          </p>
          <h1 className="font-serif text-5xl sm:text-6xl text-base-content font-bold mb-5">
            {t("contact.title")}
          </h1>
          <p className="text-sm sm:text-base text-stone-700 dark:text-stone-300 font-medium max-w-xl mx-auto leading-relaxed">
            {t("contact.desc")}
          </p>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    />
                    <span className="absolute top-3 right-4 text-stone-600 dark:text-stone-400 font-medium text-xs">
                      *
                    </span>
                  </div>
                  <div className="relative">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute top-3 right-9 text-stone-600 dark:text-stone-400 font-medium text-xs">
                      *
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center pt-2">
                  ...
                  <p className="text-[11px] text-stone-600 dark:text-stone-400 font-medium mt-3 text-center leading-relaxed">
      ...
      <section className="px-4 pb-20">
        <div className="max-w-5xl mx-auto text-center mb-10">
          <p className="text-xs text-stone-600 dark:text-stone-400 font-medium font-bold mb-3 tracking-wide uppercase">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-[1fr_320px] gap-5">
          ...
          <div className="bg-base-200 border border-base-300 rounded-2xl p-7 flex flex-col gap-6">
            <div>
              <p className="text-xs text-stone-700 dark:text-stone-300 font-medium uppercase tracking-wide mb-1.5">
                {t("contact.address")}
              </p>
            ...
            <div className="flex gap-2.5 mt-auto pt-2">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={s}
                  className="w-9 h-9 rounded-full bg-base-100 border border-base-300 flex items-center justify-center text-stone-700 dark:text-stone-300 font-medium hover:border-primary hover:text-primary transition-colors text-xs"
                >
                  {s[0].toUpperCase()}
                </a>
              ))}
