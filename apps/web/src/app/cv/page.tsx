  ...
  return (
    <div className="flex flex-col min-h-screen bg-base-100 text-base-content text-start select-none print:pt-0">
      ...
      <header className="navbar bg-base-200 border-b border-base-300 py-3 px-6 flex justify-between flex-wrap gap-4 items-center print:hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={() =>
              document.getElementById("resumeFileUploadTrigger")?.click()
            }
      ...
      <div className="flex-grow grid grid-cols-1 lg:grid-cols-12 gap-6 p-4 sm:p-6 overflow-hidden items-stretch">
        ...
        <aside className="hidden xl:flex xl:col-span-2 flex-col justify-between border border-base-300 bg-base-200 p-4 rounded-xl min-h-[580px] text-xs print:hidden">
          <div className="space-y-6">
            ...
            <nav className="space-y-1">
              <Link
                href="/dashboard"
                className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-base-300 text-base-content/75 font-bold transition-colors"
              >
                <DashboardIcon />
              ...
              <Link
                href="/cv"
                className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-primary/10 text-primary border border-primary/10 font-bold transition-colors"
              >
                <FileIcon />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-primary/5 border border-primary/25 rounded-xl p-3 text-center space-y-2">
              <p className="font-bold text-[9px] text-primary leading-normal">
                {t("cv.sidebar.upgrade")}
              </p>
              <Link
                href="/pricing"
                className="btn bg-primary hover:bg-[#059669] btn-xs rounded-lg text-white btn-block border-none font-bold"
              >
                {locale === "en" ? "Upgrade plan" : "ترقية الحساب"}
              </Link>
            </div>
            ...
            <div className="bg-base-300/40 border border-base-300 rounded-xl p-3 text-center space-y-2">
              ...
              <p className="text-[8px] text-base-content/50 leading-normal">
                {locale === "en"
                  ? "Install SmartRoadmap locally for offline access."
                  : "ثبّت التطبيق محلياً لتصفحه بدون اتصال."}
              </p>
              <button
                type="button"
            ...
            <div className="flex items-center gap-2 px-1 py-2 border-t border-base-300">
              {cv.personal?.photoUrl ? (
                ...
                <div className="w-8 h-8 rounded-full bg-primary/15 text-primary flex items-center justify-center font-bold text-xs shrink-0">
                  {firstName ? firstName[0] : "H"}
                  {lastName ? lastName[0] : "W"}
                </div>
              )}
              <div className="truncate flex-1 text-left">
                <p className="font-bold truncate leading-none text-base-content">
                  {firstName || "Harry"} {lastName || "Wells"}
                </p>
                <span className="text-[8px] text-base-content/40 uppercase font-semibold leading-none mt-1 block">
                  Premium User
                </span>
              </div>
            </div>
        ...
        <section
          className={`col-span-1 lg:col-span-6 xl:col-span-5 card bg-base-200 border border-base-300 shadow-sm overflow-hidden min-h-[580px] h-[80vh] flex flex-col rounded-xl print:hidden ${mobileView === "editor" ? "flex" : "hidden lg:flex"}`}
        >
          {/* Header Tabs */}
            ...
            {activeTab === "fillin" ? (
                ...
                <div className="flex items-center justify-between bg-base-100 border border-base-300 p-4 rounded-xl">
                  <div>
                    <h3 className="font-extrabold text-xs">
                      {t("cv.form.complication")}
                    </h3>
                    <p className="text-[9px] text-base-content/40 mt-0.5">
                      {locale === "en"
                        ? "Fill details to reach 100%"
                        : "أدخل البيانات الأساسية للوصول لنسبة ١٠٠٪"}
                    </p>
                  </div>
                  <div
                    className="radial-progress text-primary font-mono font-bold text-xs"
                    style={
                      {
                  ...
                  <div className="collapse-content space-y-4 pt-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 bg-base-200 border border-dashed border-base-300 p-3 rounded-lg w-full">
                      ...
                      <div className="text-center sm:text-left flex-1 space-y-1">
                        <p className="font-bold text-[10px] text-base-content">
                          {t("cv.form.photo_title")}
                        </p>
                        <p className="text-[9px] text-base-content/40 leading-normal">
                          {t("cv.form.photo_desc")}
                        </p>
                        <button
                          type="button"
                          onClick={() =>
                            document.getElementById("cvPhotoFileInput")?.click()
                          }
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="form-control">
                        <label className="label text-[10px] font-bold uppercase text-base-content/40">
                          {t("cv.form.first_name")}
                        </label>
                        <input
                          type="text"
                          value={firstName}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="form-control">
                        <label className="label text-[10px] font-bold uppercase text-base-content/40">
                          {locale === "en" ? "Address" : "العنوان الجغرافي"}
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="collapse-content space-y-4 pt-1">
                    <div className="flex justify-end">
                      <button
                        ...
                        className="btn bg-primary hover:bg-[#059669] text-white border-none btn-xs rounded-lg font-bold"
                      >
                        {t("cv.add_exp")}
                      </button>
                    </div>
                    ...
                    {cv.experience &&
                      cv.experience.map((exp, i) => (
                        <div
                          key={i}
                          className="bg-base-200 border border-base-300 p-4 rounded-xl space-y-3 relative"
                        >
                          <button
                            type="button"
                          ...
                          <div className="grid grid-cols-2 gap-3 pt-4">
                            <div className="form-control">
                              <label className="label text-[9px] font-bold uppercase text-base-content/40">
                                {t("cv.company")}
                              </label>
                              <input
                                type="text"
                          ...
                          <div className="form-control">
                            <div className="flex justify-between items-baseline mb-1">
                              <label className="text-[9px] font-bold uppercase text-base-content/40">
                                {t("cv.description")}
                              </label>
                              <button
                                type="button"
                    ...
                    {cv.projects &&
                      cv.projects.map((proj, i) => (
                        ...
                        >
                          ...
                          <div className="form-control">
                            <label className="label text-[9px] font-bold uppercase text-base-content/40">
                              {locale === "en" ? "Project URL" : "رابط المشروع"}
                            </label>
                            <input
                              type="text"
                              value={proj.url}
                          ...
                          <div className="form-control">
                            <label className="label text-[9px] font-bold uppercase text-base-content/40">
                              {locale === "en" ? "Description" : "شرح المشروع"}
                            </label>
                            <textarea
                            ...
                            <div className="form-control">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  const updated = [...cv.education];
                                  if (updated[i])
                                    updated[i].graduateDate = e.target.value;
                                  setCv({ ...cv, education: updated });
                                }}
                                className="input input-bordered input-xs sm:input-sm w-full font-semibold bg-base-100 text-base-content"
                                placeholder="2023-06"
                ...
                <div className="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl">
                  ...
                  <div className="collapse-content space-y-4 pt-1">
                    <div className="form-control">
                      <label className="label text-[10px] font-bold uppercase text-base-content/40">
                        {locale === "en"
                          ? "Add skill tags (separated by comma)"
                          : "أضف المهارات (مفصولة بفاصلة)"}
                      </label>
                      <input
                        type="text"
              ...
              <div className="p-4 bg-base-100 rounded-xl border border-base-300">
                <p className="font-bold mb-2 flex items-center gap-1.5">
                  <LightbulbIcon /> Assistant tab: {activeTab}
                </p>
                <p className="text-[10px] text-base-content/50 leading-relaxed">
                  Analyze and match your skill sets with our personalized career
                  roadmaps and real-time job market matching values.
                </p>
              </div>
            )}
          </div>
        ...
        <section
          ...
          className={`col-span-1 lg:col-span-6 xl:col-span-5 h-[80vh] flex flex-col items-center bg-[#525659] border border-base-300 rounded-xl p-4 shadow-inner overflow-hidden ${mobileView === "preview" ? "flex" : "hidden lg:flex"}`}
        >
          <div className="w-full flex justify-between items-center mb-3 print:hidden">
            <span className="text-[9px] font-bold text-white uppercase tracking-widest font-mono">
              Live typeset preview (A4 Format)
            </span>
            <button
          ...
          <div
            id="cv-preview-sheet"
            className="flex-grow w-full max-w-[595px] bg-white text-gray-800 shadow-2xl rounded border border-gray-300 overflow-y-auto text-left relative flex flex-col font-serif select-text"
          >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-[9px] text-gray-500 font-sans mt-3">
                    <div className="flex items-center gap-1.5">
                      <PhoneIcon className="w-3 h-3 text-[#10B981]" />{" "}
                      {phoneCountry} {cv.personal?.phone || "123456789"}
                    </div>
                    <div className="flex items-center gap-1.5">
                      <EmailIcon className="w-3 h-3 text-[#10B981]" />{" "}
                      {cv.personal?.email || "harry.wells@example.com"}
                    </div>
                    {cv.personal?.address && (
                      <div className="flex items-center gap-1.5">
                        <MapPinIcon className="w-3 h-3 text-[#10B981]" />{" "}
                        {cv.personal.address}
                      </div>
                    )}
                    {cv.personal?.website && (
                      <div className="flex items-center gap-1.5">
                        <LinkIcon className="w-3 h-3 text-[#10B981]" />{" "}
                        {cv.personal.website}
                      </div>
                    )}
                  </div>
                    ...
                    <div className="space-y-3 font-sans">
                      {cv.education.map((edu, idx) => (
                        <div key={idx} className="space-y-0.5">
                          <p className="font-extrabold text-[8.5px] text-gray-900 leading-tight">
                            {edu.degree || "Degree"}
                          </p>
                          <p className="text-[8px] text-gray-500 leading-tight">
                            {edu.fieldOfStudy || "Field"}
                          </p>
                          <p className="text-[8px] text-[#10B981] leading-tight font-semibold">
                            {edu.school || "School"}
                          </p>
                          <p className="text-[7.5px] text-gray-400 font-mono">
                            {edu.graduateDate || "Grad Date"}
                          </p>
                        </div>
                      ))}
                    </div>
                      ...
                      {cv.experience.map((exp, idx) => (
                        <div key={idx} className="space-y-1">
                          <div className="flex justify-between items-baseline font-sans">
                            <span className="font-extrabold text-[9.5px] text-gray-900">
                              {exp.role || "Role"}
                            </span>
                          ...
                          <p className="text-[8.5px] text-[#10B981] font-bold font-sans">
                            {exp.company || "Company"}
                          </p>
                      ...
                      {cv.projects.map((proj, idx) => (
                        <div key={idx} className="space-y-1 font-sans">
                          <div className="flex justify-between items-baseline">
                            <span className="font-extrabold text-[9px] text-gray-900">
                              {proj.name || "Project Name"}
                            </span>
                            {proj.url && (
                              <span className="text-[7.5px] text-[#10B981] truncate max-w-[150px]">
                                {proj.url}
                              </span>
                            )}
                          </div>
                      ...
                      {filteredSkills.map((skill, idx) => (
                        <div key={idx} className="space-y-1">
                          <div className="flex justify-between items-center text-[8px] font-bold text-gray-800">
                            <span>{skill}</span>
                            <span className="text-[7px] text-emerald-600 bg-emerald-50 px-1 rounded-sm border border-emerald-100">
                              Verified
                            </span>
                          </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 font-sans text-[8.5px]">
                        {cv.references.map((ref, idx) => (
                          <div key={idx} className="space-y-0.5 text-gray-600">
                            ...
                            <p className="flex items-center gap-1">
                              <EmailIcon className="w-2.5 h-2.5 text-gray-400" />{" "}
                              {ref.email || "Email"}
                            </p>
                          </div>
                        ))}
