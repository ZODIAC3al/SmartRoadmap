...
export default function NotificationsPage() {
      ...
      if (res.ok) {
        ...
        toast.success(
          locale === "en"
            ...
            : "تم تحديد كافة التنبيهات كمقروءة.",
        );
      }
    } catch (e) {}
  };
  ...
  const handleDelete = async (id: string, e: React.MouseEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(
          locale === "en" ? "Notification deleted." : "تم حذف التنبيه.",
        );
      }
    } catch (e) {}
  };
  ...
  const dict = {
    ...
    subtitle: {
      en: "Stay updated with your career progress and messages.",
      ar: "تابع تقدمك المهني ورسائلك أولاً بأول.",
    },
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-base-300 pb-4">
          ...
          <div className="flex gap-2">
            <Link
              href="/dashboard"
              className="btn btn-outline border-base-300 btn-xs sm:btn-sm rounded-lg text-xs font-bold"
            >
              {getLabel("back")}
            </Link>
