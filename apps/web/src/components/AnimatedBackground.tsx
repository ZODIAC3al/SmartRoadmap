...
export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden pointer-events-none opacity-30 dark:opacity-20 transition-opacity duration-1000">
      ...
      <div className="absolute bottom-[-20%] right-[-20%] w-[60%] h-[60%] rounded-full bg-gradient-to-br from-[#E8C999]/40 to-[#E8C999]/40 blur-[100px] animate-blob animation-delay-2000" />
