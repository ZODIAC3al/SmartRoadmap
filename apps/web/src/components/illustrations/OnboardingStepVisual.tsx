...
export default function OnboardingStepVisual({
  ...
  return (
    <div
      className={`bg-base-100 dark:bg-base-300 border border-base-300 dark:border-base-300 rounded-3xl p-6 sm:p-8 flex flex-col items-center justify-center text-center shadow-xl relative overflow-hidden select-none max-w-sm w-full ${className}`}
    >
      ...
      {step === 3 && (
        <div className="space-y-4">
          <motion.div
            ...
            className="w-20 h-20 rounded-3xl bg-primary text-primary-content/10 text-primary border border-primary/25 flex items-center justify-center text-3xl mx-auto shadow-inner"
          >
            ⏱️
          </motion.div>
          <div>
      ...
      {step === 4 && (
        <div className="space-y-4">
          <motion.div
            ...
            className="w-20 h-20 rounded-3xl bg-[#8E1616]/10 text-[#701111] border border-[#8E1616]/25 flex items-center justify-center text-3xl mx-auto shadow-inner"
          >
            🚀
          </motion.div>
          <div>
