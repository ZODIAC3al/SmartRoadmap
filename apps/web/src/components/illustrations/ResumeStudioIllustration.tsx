...
export default function ResumeStudioIllustration({
  ...
  return (
    <div className={`relative flex items-center justify-center select-none ${className}`}>
      ...
      <div className="absolute w-72 h-72 bg-gradient-to-tr from-[#8E1616]/15 via-amber-500/15 to-emerald-500/15 rounded-full blur-2xl animate-pulse" />
      ...
      <div className="relative w-72 sm:w-80 bg-base-100 rounded-2xl border-2 border-base-300 shadow-2xl p-5 overflow-hidden text-start">
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-base-300">
          ...
          <div>
            <div className="h-3 w-28 bg-stone-800 dark:bg-stone-200 rounded-full mb-1" />
            <div className="text-[10px] font-mono font-bold text-[#8E1616]">
              {roleTitle}
            </div>
          </div>
          <div className="ml-auto px-2 py-0.5 rounded-md bg-emerald-500/15 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 font-mono text-[10px] font-black">
            ATS {atsScore}%
          </div>
        </div>
        ...
        <div className="space-y-3 pt-3">
          ...
          <div className="p-2.5 rounded-xl bg-base-200 border border-base-300 space-y-1">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[9px] font-mono text-emerald-600 font-bold">100% Score</span>
            </div>
        ...
        <div className="absolute bottom-3 right-3 px-2.5 py-1 rounded-lg bg-gradient-to-r from-[#8E1616] to-[#701111] text-white text-[9px] font-black shadow-md flex items-center gap-1 animate-pin-float">
          <span>★ Verified</span>
        </div>
      </div>
    </div>
